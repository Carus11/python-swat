...
#       swat.options.cas.trace_strings = True
    ...
    def test_basic_connection(self):
        self.assertTrue(self.s._hostname == HOST or self.s._hostname.split('.')[0] == HOST)
    ...
    def test_alltypes(self):
        ...
        # The int64 value is too big for JSON and overflows to MIN_INT64.
        # This causes the value to be a NaN which can only exist in a 
        # double column, so pandas automatically converts the column to 
        # that type.
        if self.s._protocol in ['http', 'https']:
            self.assertTrue(np.isnan(data.ix[:,'Int64'][0]))
        ...
        self.assertEqual(data.ix[:,'Binary'][0], b'\x6e\x6f\x70\x71\x72\x73\x74\x75\x76\x77\x78\x79\x7a\x7b\x7c\x7d\x7e\x7f\x80\x81\x82\x83\x84\x85\x86\x87\x88\x89\x8a\x8b\x8c\x8d')
        ...
        self.assertEqual(data.ix[:,'Varbinary'][0], b'')
    ...
    def test_attrs(self):        
        ...
        self.assertEqual(out.attrs.get('Action', ''), 'summary')
        self.assertEqual(out.attrs.get('Actionset', ''), 'simple')
        self.assertNotEqual(out.attrs.get('CreateTime', -1), 0)
